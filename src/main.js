...
const completedAudio = await createSound(new URL('./assets/completed.wav', import.meta.url).href)



document.addEventListener('click', delegatedHandler('[data-add-time]', e => {
    console.log('click')
...
document.addEventListener('click', delegatedHandler('[data-clear]', ()=>{
    clear();
}))
